...
>***NOTE**: Additional modules listed in the main menu that are not grouped into
...
>**NOTE**: In addition to the controls available on the `Organization Settings`
...
>**NOTE**: Several module landing pages, including
...
- **Portal sections** (center three
  ...
  >**NOTE**: The portal sections list is covered with a
...
>**NOTE*: Any changes to favorites made in the
Search modal are not reflected in the modal until the next time it's opened.
...
>**NOTE**: The display of any group in the `Results` list may be
toggled on/off by clicking the corresponding element in the **Type List**.
...
>**NOTE**: If the group corresponding to a given type is
...
>**NOTE**: For shortcuts that are applicable across the portal, see
[Portal Keyboard Shortcuts](#portal-keyboard-shortcuts).
